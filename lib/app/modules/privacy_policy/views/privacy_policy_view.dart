        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextRegular(
                text:
                    'We automatically collect information when you use the App, including:',
              ),
              ...
              _buildTextRegularBulletPoint(
                text: 'Crash logs and performance data',
              ),

              _buildTextRegular(padding: 14, text: 'c) Cookies & Tracking'),
              _buildTextRegular(
                text:
                    'We may use cookies, analytics tools, and similar technologies to improve user experience.',
              ),
              ...
              _buildTextRegularBulletPoint(
                text: 'Provide and improve App services',
              ),
              _buildTextRegularBulletPoint(text: 'Process payments securely'),
              _buildTextRegularBulletPoint(
                text: 'Connect users within the App',
              ),
              _buildTextRegularBulletPoint(
                text: 'Send notifications and important updates',
              ),
              _buildTextRegularBulletPoint(
                text: 'Prevent fraud and ensure safety',
              ),
              _buildTextRegularBulletPoint(
              ...
              _buildTextRegularBulletPoint(
                text:
                    'Service providers (payment gateways, analytics, hosting)',
              ),
              _buildTextRegularBulletPoint(
              ...
              _buildTextRegularBulletPoint(
                text:
                    'Business partners (only when necessary and with protection)',
              ),

              _buildTextRegular(
                padding: 14,
                text:
                    'All shared data follows strict privacy and security guidelines.',
              ),
              ...
              _buildTextRegularBulletPoint(
                text: 'Update or delete your information',
              ),
              ...
              _buildTextRegular(
                padding: 14,
                text:
                    'To request any action, contact us at [Your Support Email].',
              ),
