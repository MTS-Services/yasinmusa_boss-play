        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextRegular(
                text:
                    'You must use the App responsibly and only for lawful purposes. You agree not to:',
              ),

              _buildTextRegularBulletPoint(
                text: 'Misuse the App or attempt unauthorized access',
              ),
              _buildTextRegularBulletPoint(
                text: 'Upload harmful, illegal, or abusive content',
              ),
              _buildTextRegularBulletPoint(
                text: 'Engage in fraudulent activities',
              ),
              _buildTextRegularBulletPoint(
                text: 'Violate others’ privacy or rights',
              ),
              ...
              _buildTextRegularBulletPoint(
                text: 'Be responsible for all activities under your account',
              ),

              _buildTextRegular(
                padding: 14,
                text:
                    'We may suspend or delete accounts that violate our rules.',
              ),
              ...
              _buildTextRegular(
                text:
                    'You may upload or submit content within the App. You agree that:',
              ),

              _buildTextRegularBulletPoint(
                text: 'Your content must not violate any laws',
              ),
              _buildTextRegularBulletPoint(
                text: 'You own or have permission to use the content',
              ),
              _buildTextRegularBulletPoint(
                text: 'We may use your content to operate and improve the App',
              ),
              _buildTextRegularBulletPoint(
                text: 'We may remove content that violates our guidelines',
              ),
              ...
              _buildTextRegularBulletPoint(
                text: 'Recreate or reverse-engineer the App',
              ),
              _buildTextRegularBulletPoint(
                text: 'Use our trademarks without permission',
              ),
